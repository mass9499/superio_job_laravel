...
class RouterServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $moduleNamespace      = 'Plugins\PaymentFlutterWaveCheckout\Controllers';
    protected $adminModuleNamespace = 'Plugins\PaymentFlutterWaveCheckout\Admin';
    ...
    protected function mapAdminRoutes()
    {
        Route::middleware([
            'web',
            'dashboard'
        ])->namespace($this->adminModuleNamespace)->prefix('admin/module/PaymentFlutterWaveCheckout')->group(__DIR__ . '/Routes/admin.php');
    }
