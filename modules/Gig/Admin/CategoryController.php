...
class CategoryController extends AdminController
{
    ...
    public function __construct()
    {
        ...
        $this->categoryClass = GigCategory::class;
    }
    ...
    public function index(Request $request)
    {
        ...
        return view('Gig::admin.category.index', $data);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        if (empty($row)) {
            return redirect(route('gig.admin.category.index'));
        }
        ...
        $data = [
            ...
            'row'         => $row,
            'parents'     => $this->categoryClass::get()->toTree(),
            'breadcrumbs' => [
                [
                    'name' => __('Gigs'),
                    'url'  => route('gig.admin.index')
        ...
        return view('Gig::admin.category.detail', $data);
    }
